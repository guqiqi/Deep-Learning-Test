...
class DifferentialEvolutionSolver(object):
    ...
    def _calculate_population_energies(self):
        ...
        energies, imgs = self.func(parameters, *self.args)
        self.imgs = imgs
        ...
        # 把最低可能性的结果保存，这边需要把最低可能性的图片结果保存
        lowest_energy = self.population_energies[minval]
        lowest_img = self.imgs[minval]

        self.population_energies[minval] = self.population_energies[0]
        self.population_energies[0] = lowest_energy

        self.imgs[minval] = self.imgs[0]
        self.imgs[0] = lowest_img
    ...
    def __next__(self):
        ...
        for candidate,(energy,trial, img) in enumerate(zip(energies, trials, imgs)):
        ...
        return self.x, self.population_energies[0], self.imgs[0]
